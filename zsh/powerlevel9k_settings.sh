...
# 2022-12-20 PR not sure if this is the right way to add the user name
...
POWERLEVEL9K_LEFT_PROMPT_ELEMENTS=(root_indicator ssh context dir_writable dir vcs anaconda virtualenv)
...
POWERLEVEL9K_VCS_GIT_HOOKS=(vcs-detect-changes git-untracked git-tagname)
